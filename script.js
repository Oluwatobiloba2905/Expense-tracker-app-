...
function expense() {
    ...
    var history = document.createTextNode(description + " =  " + input + "   Naira   ");
    ...
    if (input == "") {
        ...
        document.getElementById("expense").innerHTML = (exp_balance - input) + " .00 Naira";
        document.getElementById("cbalance").innerHTML = total_amount + " .00 Naira"
    }
